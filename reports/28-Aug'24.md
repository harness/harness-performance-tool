...
#### [Note](#) : *The below performance tests results are obtained using Managed MongoDB and Managed Redis (as mentioned above)*  
#### *However the SMP Helm Chart by default provides in-cluster MongoDB and Redis Sentinel, thus the performance results would differ accordingly*
